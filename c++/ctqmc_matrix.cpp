...
parameter_defaults ctqmc_matrix::solve_defaults() const {
 ...
 pdef.required("n_cycles", int(), "Number of QMC cycles")
     ...
     .optional("use_norm_of_matrices_in_cache", bool(false), " Use spectral norm in estimate calculation ")
     .optional("use_only_first_term_in_trace", bool(false), " Use only the first term in the trace calculation ")
