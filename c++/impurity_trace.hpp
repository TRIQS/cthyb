...
class impurity_trace {
 ...
 arrays::vector<bool_and_matrix> atomic_rho;     // precomputed atomic density matrix
 double atomic_z;                                // precomputed atomic partition function
 double atomic_norm;                             // norm of the atomic density matrix
