...
template <> struct py_converter<solve_parameters_t> {
 ...
 static bool is_convertible(PyObject *dic, bool raise_exception) {
  ...
  std::vector<std::string> ks, all_keys = {"h_loc","n_cycles","partition_method","quantum_numbers","length_cycle","n_warmup_cycles","random_seed","random_name","max_time","verbosity","move_shift","move_double","use_trace_estimator","measure_g_tau","measure_g_l","measure_pert_order","measure_state_trace_contrib","make_histograms","proposal_prob"};
