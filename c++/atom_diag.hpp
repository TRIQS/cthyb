 ...
 */
  ...
  * @return : the number of the final block
  */
    matrix_t const &c_matrix(int op_linear_index, int block_index) const { return c_matrices[op_linear_index][block_index]; }
  ...
  * @return : the number of the final block
  */
    matrix_t const &cdag_matrix(int op_linear_index, int block_index) const { return cdag_matrices[op_linear_index][block_index]; }
