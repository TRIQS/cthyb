...
c.add_member(c_name = "loc_n_min",
             c_type = "int",
             initializer = """ 0 """,
             doc = """Restrict local Hilbert space to states with at least this number of particles\n     default: 0""")

c.add_member(c_name = "loc_n_max",
             c_type = "int",
             initializer = """ INT_MAX """,
             doc = """Restrict local Hilbert space to states with at most this number of particles\n     default: INT_MAX""")
...
c.add_member(c_name = "measure_O_tau_min_ins",
             c_type = "int",
             initializer = """ 10 """,
             doc = """Minumum of operator insertions in: O_tau by insertion measure""")
