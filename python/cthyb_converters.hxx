...
template <> struct py_converter<solve_parameters_t> {
 static PyObject *c2py(solve_parameters_t const & x) {
  ...
  PyDict_SetItemString( d, "measure_G2_iw"                , convert_to_python(x.measure_G2_iw));
  PyDict_SetItemString( d, "measure_G2_iw_pp"             , convert_to_python(x.measure_G2_iw_pp));
  PyDict_SetItemString( d, "measure_G2_iw_ph"             , convert_to_python(x.measure_G2_iw_ph));
  PyDict_SetItemString( d, "measure_G2_iwll_pp"           , convert_to_python(x.measure_G2_iwll_pp));
  PyDict_SetItemString( d, "measure_G2_iwll_ph"           , convert_to_python(x.measure_G2_iwll_ph));
  ...
  PyDict_SetItemString( d, "measure_G2_n_bosonic"         , convert_to_python(x.measure_G2_n_bosonic));
  PyDict_SetItemString( d, "measure_G2_n_fermionic"       , convert_to_python(x.measure_G2_n_fermionic));
  PyDict_SetItemString( d, "measure_G2_n_l"               , convert_to_python(x.measure_G2_n_l));
  PyDict_SetItemString( d, "measure_G2_iwll_nfft_buf_size", convert_to_python(x.measure_G2_iwll_nfft_buf_size));
 ...
 static solve_parameters_t py2c(PyObject *dic) {
  ...
  _get_optional(dic, "measure_G2_iw"                , res.measure_G2_iw                   ,false);
  _get_optional(dic, "measure_G2_iw_pp"             , res.measure_G2_iw_pp                ,false);
  ...
  _get_optional(dic, "measure_G2_n_fermionic"       , res.measure_G2_n_fermionic          ,30);
  _get_optional(dic, "measure_G2_n_l"               , res.measure_G2_n_l                  ,20);
  _get_optional(dic, "measure_G2_iwll_nfft_buf_size", res.measure_G2_iwll_nfft_buf_size   ,100);
 ...
 static bool is_convertible(PyObject *dic, bool raise_exception) {
  ...
  _check_optional <bool                                          >(dic, fs, err, "measure_G2_iw"                , "bool");
  _check_optional <bool                                          >(dic, fs, err, "measure_G2_iw_pp"             , "bool");
  _check_optional <bool                                          >(dic, fs, err, "measure_G2_iw_ph"             , "bool");
  _check_optional <bool                                          >(dic, fs, err, "measure_G2_iwll_pp"           , "bool");
  _check_optional <bool                                          >(dic, fs, err, "measure_G2_iwll_ph"           , "bool");
  ...
  _check_optional <int                                           >(dic, fs, err, "measure_G2_n_bosonic"         , "int");
  _check_optional <int                                           >(dic, fs, err, "measure_G2_n_fermionic"       , "int");
  _check_optional <int                                           >(dic, fs, err, "measure_G2_n_l"               , "int");
  _check_optional <int                                           >(dic, fs, err, "measure_G2_iwll_nfft_buf_size", "int");
