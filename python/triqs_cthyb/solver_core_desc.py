...
# c++2py ../../c++/triqs_cthyb/solver_core.hpp -p --members_read_only -N triqs_cthyb -a triqs_cthyb -m solver_core -o solver_core --moduledoc="The TRIQS cthyb solver" --cxxflags="-std=c++20" -C triqs --only="solver_core block_order"
...
# Imports
module.add_imports(*['triqs.atom_diag', 'triqs.gf', 'triqs.gf.meshes', 'triqs.operators', 'triqs.stat.histograms', 'h5._h5py'])
...
+-------------------------------+----------------------------------------------------------+-------------------------------+-------------------------------------------------------------------------------------------------------------------+
| length_cycle                  | long                                                     | 50                            | Length of a single QMC cycle                                                                                      |
+-------------------------------+----------------------------------------------------------+-------------------------------+-------------------------------------------------------------------------------------------------------------------+
| n_warmup_cycles               | long                                                     | 5000                          | Number of cycles for thermalization                                                                               |
+-------------------------------+----------------------------------------------------------+-------------------------------+-------------------------------------------------------------------------------------------------------------------+
| random_seed                   | long                                                     | 34788 + 928374 * MPI.rank     | Seed for random number generator                                                                                  |
+-------------------------------+----------------------------------------------------------+-------------------------------+-------------------------------------------------------------------------------------------------------------------+
| random_name                   | str                                                      | ""                            | Name of random number generator                                                                                   |
+-------------------------------+----------------------------------------------------------+-------------------------------+-------------------------------------------------------------------------------------------------------------------+
| max_time                      | long                                                     | -1 = infinite                 | Maximum runtime in seconds, use -1 to set infinite                                                                |
+-------------------------------+----------------------------------------------------------+-------------------------------+-------------------------------------------------------------------------------------------------------------------+
...
+-------------------------------+----------------------------------------------------------+-------------------------------+-------------------------------------------------------------------------------------------------------------------+
| measure_G2_block_order        | block_order                                              | block_order::AABB             | Order of block indices in the definition of G^2.                                                                  |
+-------------------------------+----------------------------------------------------------+-------------------------------+-------------------------------------------------------------------------------------------------------------------+
...
+-------------------------------+----------------------------------------------------------+-------------------------------+-------------------------------------------------------------------------------------------------------------------+
| initial_configuration         | std::optional<configuration>                             | {}                            | Initial configuration of the run. (advanced --> use with care!)                                                   |
+-------------------------------+----------------------------------------------------------+-------------------------------+-------------------------------------------------------------------------------------------------------------------+
| performance_analysis          | bool                                                     | false                         | Analyse performance of trace computation with histograms (developers only)?                                       |
+-------------------------------+----------------------------------------------------------+-------------------------------+-------------------------------------------------------------------------------------------------------------------+
| use_bound_as_threshold        | bool                                                     | false                         | Should we use a threshold to disregard blocks with much smaller upper bounds?                                     |
+-------------------------------+----------------------------------------------------------+-------------------------------+-------------------------------------------------------------------------------------------------------------------+
...
c.add_property(name = "average_order",
               getter = cfunction("double average_order ()"),
...
c.add_property(name = "last_configuration",
               getter = cfunction("std::optional<configuration> last_configuration ()"),
               doc = r"""Final configuration of the last solve call.""")

c.add_property(name = "hybridisation_is_complex",
               getter = cfunction("bool hybridisation_is_complex ()"),
               doc = r"""is cthyb compiled with support for complex hybridization?""")

c.add_property(name = "local_hamiltonian_is_complex",
               getter = cfunction("bool local_hamiltonian_is_complex ()"),
               doc = r"""is cthyb compiled with support for complex local Hamiltonian""")
...
c.add_member(c_name = "initial_configuration",
             c_type = "std::optional<configuration>",
             initializer = """ {} """,
             doc = r"""Initial configuration of the run. (advanced --> use with care!)""")
...
c.add_member(c_name = "use_bound_as_threshold",
             c_type = "bool",
             initializer = """ false """,
             doc = r"""Should we use the largest upper bound for the block contribution to the trace to disregard blocks with much smaller upper bounds?""")
