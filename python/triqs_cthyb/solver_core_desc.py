...
# The module
module = module_(full_name = "solver_core", doc = "The TRIQS cthyb solver", app_name = "triqs_cthyb")
...
module.add_enum("block_order", ['block_order::AABB', 'block_order::ABBA'], "triqs_cthyb", """Order of block indices for Block2Gf objects""")
...
c.add_member(c_name = "O_tau",
             ...
             read_only= True,
             doc = """General operator Green\'s function :math:`O(\\tau)` in imaginary time.""")
...
c.add_member(c_name = "measure_O_tau",
             ...
             doc = """Measure O_tau by insertion""")
