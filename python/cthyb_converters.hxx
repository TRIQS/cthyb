...
template <> struct py_converter<solve_parameters_t> {
 static PyObject *c2py(solve_parameters_t const & x) {
  ...
  PyDict_SetItemString( d, "measure_g2_inu_fermionic", convert_to_python(x.measure_g2_inu_fermionic));
 ...
 static solve_parameters_t py2c(PyObject *dic) {
  ...
  _get_optional(dic, "measure_g2_inu_fermionic", res.measure_g2_inu_fermionic   ,false);
  _get_optional(dic, "measure_g2_pp"           , res.measure_g2_pp              ,false);
  _get_optional(dic, "measure_g2_ph"           , res.measure_g2_ph              ,false);
 ...
 static bool is_convertible(PyObject *dic, bool raise_exception) {
  ...
  _check_optional <bool                                          >(dic, fs, err, "measure_g2_inu_fermionic", "bool");
