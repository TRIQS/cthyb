...
namespace triqs_cthyb {
  ...
  void solver_core::solve(solve_parameters_t const &solve_parameters_) {
    ...
    if (params.measure_G_iw) qmc.add_measure(measure_G_iw{data, params.measure_G_n_iw, gf_struct, container_set()}, "G_iw measure");
    // FIXME : measure gl is unlike g_tau and g_iw
